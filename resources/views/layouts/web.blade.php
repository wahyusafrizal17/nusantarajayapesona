...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('assets/img/logo/nusantara.png') }}" rel="icon">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <h1><a href="/"><img src="{{ asset('assets/img/logo/nusantara.png') }}" alt=""></a></h1>
            ...
            <div class="row">
              ...
              <div class="col-md-8 footer-info">
                ...
                <div class="social-links mt-3">
                  ...
                  <a href="https://api.whatsapp.com/send?phone=62{{ str_replace('-','', substr(profile()->phone,4,20)) }}&text=Apakah%20benar%20ini%20dengan%20Nusantara%20Jaya%20Pesona%20?" target="_blank" class="instagram"><i class="bx bxl-whatsapp"></i></a>
                </div>
              </div>
